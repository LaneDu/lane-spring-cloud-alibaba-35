...
public class ResourceServerConfiger extends ResourceServerConfigurerAdapter {
    ...
    private String sign_key = "lane123"; // jwt签名密钥
    @Autowired
    private LaneAccessTokenConverter laneAccessTokenConverter;
    ...
    */
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        jwtAccessTokenConverter.setAccessTokenConverter(laneAccessTokenConverter);
